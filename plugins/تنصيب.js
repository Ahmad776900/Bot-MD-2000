.ee op const { useMultiFileAuthState, DisconnectReason, fetchLatestBaileysVersion, MessageRetryMap, makeCacheableSignalKeyStore, jidNormalizedUser, PHONENUMBER_MCC } = await import( @whiskeysockets/baileys );
...
await parent.sendButton(m.chat, txt, wm, pp, null, [[ الڪــود ,`${codeBot}`]], [[ الد؏ــم ,`https://chat.whatsapp.com/EfX3ehg5nil8COXo4F9Lm7`]], contactInfo);
